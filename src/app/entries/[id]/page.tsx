...
export default function EntryPage() {
  ...
  const handleGeneratePdf = async () => {
    ...
    pdf.setTextColor(0, 50, 67); // #003243 in RGB
    ...
    // Calculate dimensions for the content image
    ...
    // Update position after content
    yPosition += contentImgHeight + 15;

    // Remove media section - as requested by user
