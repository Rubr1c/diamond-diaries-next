        ...
        <div className="flex flex-col items-center mb-6">
          ...
          <div className="flex gap-4 mb-6 items-center justify-center">
            ...
            <button
              ...
              className="flex items-center px-3 py-2 bg-white rounded-lg border border-gray-300 shadow-sm hover:shadow-md hover:scale-105 transition-all duration-200 cursor-pointer"
            >
              {entry?.isFavorite ? (
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className={`h-5 w-5 text-red-500 ${heartAnimationClass}`}
                  fill="currentColor"
                  viewBox="0 0 24 24"
                >
                ...
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className={`h-5 w-5 text-gray-300 hover:text-red-400 ${heartAnimationClass}`}
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
            ...
            <button
              ...
              className="flex items-center px-3 py-2 bg-red-500 text-white rounded-lg shadow-sm hover:bg-red-600 hover:shadow-md hover:scale-105 transition-all duration-200 cursor-pointer"
            >
              <Trash2 className="h-5 w-5" />
            </button>
          </div>
